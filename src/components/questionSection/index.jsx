...
const QuestionSection = () => {
  ...
  const handleQuestionClick = (categoryIndex, questionIndex) => {
    const currentIndex = openQuestionIndex[categoryIndex] === questionIndex ? null : questionIndex;
    setOpenQuestionIndex({ ...openQuestionIndex, [categoryIndex]: currentIndex });
  };
  const faqData = [
    {
      heading: "General",
    ...
    {
      heading: "Top-shelf packaging design",
      items: [
  ...
  return (
    <div className='question-section'>
      {faqData?.map((category, categoryIndex) => (
        <div key={categoryIndex} className='question-card-section'>
          ...
          {category.items?.map((item, questionIndex) => (
            <div key={questionIndex} >
              <QuestionCard
                ...
                isOpen={openQuestionIndex[categoryIndex] === questionIndex}
              />
              {openQuestionIndex[categoryIndex] === questionIndex && (
                <div className='question-card-answer'>
                  <Typography fontSize={"16px"} color={"#000"} style={{ marginTop: '10px' }}>
                    {item.answer}
                  </Typography>
                </div>
              )}
